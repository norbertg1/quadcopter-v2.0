...
static __declspec(vectortable) tVectorTable __vect_table = { /* Interrupt vector table */
   __SP_INIT,                                              /* 0 (0x00000000) (prior: -) */
  {
   ...
   (tIsrFunc)SysTickIrq,                               /* 15 (0x0000003C) (prior: -) */
   ...
   (tIsrFunc)UART_interrupt,                               /* 69 (0x00000114) (prior: -) */
   ...
   (tIsrFunc)PID_Interrupt,                               /* 84 (0x00000150) (prior: -) */
   ...
   (tIsrFunc)capture_ppm_PORTA,                               /* 103 (0x0000019C) (prior: -) */
   ...
   (tIsrFunc)capture_ppm_PORTE,                               /* 107 (0x000001AC) (prior: -) */
