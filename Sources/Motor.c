...
void SetMotorPWM(int MotorA , int MotorB, int MotorC, int MotorD)
{
	...
	FTM0_C7V = ELEMENTARY_PROC_TIME*((ESC_MINIMUM_POWER+(ESC_POWER_DIFFERENCE)*((float)MotorA/1000))/1000);
	FTM0_C7V = ELEMENTARY_PROC_TIME*((ESC_MINIMUM_POWER+(ESC_POWER_DIFFERENCE)*((float)MotorB/1000))/1000);
	FTM0_C7V = ELEMENTARY_PROC_TIME*((ESC_MINIMUM_POWER+(ESC_POWER_DIFFERENCE)*((float)MotorC/1000))/1000);
	FTM0_C7V = ELEMENTARY_PROC_TIME*((ESC_MINIMUM_POWER+(ESC_POWER_DIFFERENCE)*((float)MotorD/1000))/1000);
#else
	FTM0_C7V = 0;
	FTM0_C7V = 0;
	FTM0_C7V = 0;
